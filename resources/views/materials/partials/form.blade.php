...
<div class="form-group">
    ...
    <input type="text" name="referencia" value="{{ old('referencia', $material->referencia) }}" class="form-control" id="matRef" aria-describedby="matRefHelp" required>
...
<div class="form-group">
    ...
    <input type="text" name="nom" value="{{ old('nom', $material->nom) }}" class="form-control" id="matNom" aria-describedby="matNomHelp" required>
...
<div class="form-group">
    ...
    <input type="number" min="0" name="quantitat_prevista" value="{{ old('quantitat_prevista', $material->quantitat_prevista) }}" class="form-control" id="matPre" aria-describedby="matPreHelp" required>
...
<div class="form-group">
    ...
    <input type="number" min="0" name="quantitat" value="{{ old('quantitat', $material->quantitat) }}" class="form-control" id="matRea" aria-describedby="matReaHelp">
...
<div class="form-group">
    ...
    <select name="es_del_parc" class="form-control" id="matPar" aria-describedby="matParHelp">
        <option value="1" {{ old('es_del_parc', $material->es_del_parc) == 1 ? 'selected' : '' }}>Sí</option>
        <option value="0" {{ old('es_del_parc', $material->es_del_parc) == 0 ? 'selected' : '' }}>No</option>
    </select>
